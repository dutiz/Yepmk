...
<div class="container">
    <div class="mt-40">
        <h1 class="text-purple-500 font-bold text-5xl text-center px-40">Empowering today's youth, building tomorrow's leaders ! </h1>
    </div>
...
<div class="mt-48 container">
    ...
    <p class=" text-xs  text-center block">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Amet<br> ad fuga voluptates eligendi, officia consectetur corrupti ipsam?</p>
</div>
<div class="container ">
